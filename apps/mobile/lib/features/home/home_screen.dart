...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayName =
        (user?['display_name']?.toString().trim().isNotEmpty ?? false)
          ...
          SliverPadding(
            ...
            sliver: SliverList.list(
              children: [
                ...
                const Text(
                  'Turn your documents into searchable, cited knowledge.',
                ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'A workspace keeps documents, chats, notes, quizzes, and study cards isolated together.',
                          ),
                  ...
                  if (_documents.isEmpty)
                    const Card(
                      child: Padding(
                        ...
                        child: Text(
                          'No documents yet. Upload your first file from the Documents tab.',
                        ),
                      ),
                    )
                  else
                        ...
                        .map(
                          (document) => Card(
                            child: ListTile(
                              ...
                              subtitle: Text(
                                '${document['status'] ?? 'pending'} · ${document['processing_progress'] ?? 0}%',
                              ),
