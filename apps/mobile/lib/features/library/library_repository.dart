...
class LibraryRepository {
  ...
  Future<List<Map<String, dynamic>>> collections(String workspaceId) =>
      _list('/collections', workspaceId, 'collections');
  Future<List<Map<String, dynamic>>> folders(String workspaceId) =>
      _list('/folders', workspaceId, 'folders');
  Future<List<Map<String, dynamic>>> tags(String workspaceId) =>
      _list('/tags', workspaceId, 'tags');
  Future<List<Map<String, dynamic>>> prompts(String workspaceId) =>
      _list('/saved-prompts', workspaceId, 'saved_prompts');
  ...
  Future<void> createFolder(String workspaceId, String name) async {
    await _api.dio.post(
      '/folders',
      data: {'workspace_id': workspaceId, 'name': name.trim()},
    );
  }
